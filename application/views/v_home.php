...
<html>
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="<?php echo base_url()?>assets/porto/img/favicon.ico" type="image/x-icon" />
		<link rel="apple-touch-icon" href="<?php echo base_url()?>assets/porto/img/apple-touch-icon.png">
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="<?php echo base_url()?>assets/porto/css/demos/demo-one-page-agency.css">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="<?php echo base_url()?>assets/porto/css/skins/skin-one-page-agency.css"> 
	...
	<body data-spy="scroll" data-target=".wrapper-spy" data-offset="100">
		...
		<div class="body">
								...
								<div class="header-row">
									<div class="header-logo px-4">
										<a href="<?php echo base_url()?>">
											<img alt="Porto One Page Agency" width="101" height="21" src="<?php echo base_url()?>assets/porto/image/logo.png">
										</a>
									</div>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1">
											<nav class="wrapper-spy collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li>
														<a class="nav-link" href="#contact" data-hash data-hash-offset="32">
															Contact us
														</a>
													</li>
												</ul>
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider manual rev_slider" data-version="5.4.8">
						<ul>
							<li data-transition="fade">
								<img src="<?php echo base_url()?>assets/porto/image/background.png"
									alt=""
									data-bgopacity = "0.8"
								...
								<h1 class="tp-caption text-color-light font-weight-bold"
									...
									data-start="500"
									data-fontsize="80"
									data-transform_in="y:[-300%];opacity:0;s:500;">MSGLOW</h1>

								<div class="tp-caption text-color-light"
									data-x="['left','left','left','left']" data-hoffset="['0','0','30','85']"
									data-y="['center','center','center','center']" data-voffset="['-10','-10','-10','0']"
									data-start="1500"
									data-fontsize="['20','20','20','27']"
									data-whitespace="nowrap"
									data-transform_in="y:[100%];s:500;"
									data-transform_out="opacity:0;s:500;"
									data-mask_in="x:0px;y:0px;">Palembang</div>
							</li>
						</ul>
					</div>
				</div>
										...
										<div class="portfolio-item">
												<span class="thumb-info thumb-info-lighten border-radius-0">
													<span class="thumb-info-wrapper border-radius-0">
														<img src="<?php echo base_url()?>assets/image_barang/<?php echo $gambar?>" class="img-fluid border-radius-0" alt="">
														<span class="thumb-info-title">
															<span class="thumb-info-inner"><?php echo $barang_nama?></span>
															<span class="thumb-info-type"><?php echo rupiah($harga_normal)?></span>
														</span>
				...
				<section id="contact" class="section section-no-border bg-color-light m-0 pb-4">
					<div class="container">
						<div class="row justify-content-center">
							<div class="col">
									<div class="col-lg-6">
										...
										<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
											<h4 class="mt-2 mb-1"><strong>Order / Konsul</strong></h4>
		...
		<!-- Demo -->
		<script src="<?php echo base_url()?>assets/porto/js/demos/demo-one-page-agency.js"></script>
