    ...
    <div class="row">   
      <div class="col-xl-12 mb-30">     
        <div class="card card-statistics h-100"> 
          <div class="card-body">
            <div class="col-xl-12 mb-10">
              <a href="" data-toggle="modal" data-target="#kategori" class="btn btn-primary btn-block ripple m-t-20">
                  <i class="fa fa-plus pr-2"></i> Tambah Kategori
              </a>
            </div>
                ...
                foreach($kategori->result_array() as $i) {
                  ...
                  <tr>
                     <td><center><?php echo $no?></center></td>
                      ...
                      <td>
                          <a href="#" style="margin-right: 10px; margin-left: 10px;" data-toggle="modal" data-target="#editdata<?php echo $kategori_id?>"><span class="ti-pencil"></span></a>
                          <a href="#" style="margin-right: 10px" data-toggle="modal" data-target="#hapusdata<?php echo $kategori_id?>"><span class="ti-trash"></span></a>
                      </td>
                    </tr>
                  <?php }?>
              </tbody>
       ...
       <!-- Modal Add Barang Reseller-->
        <div class="modal" tabindex="-1" role="dialog" id="kategori">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Owner/Barang/savekategori" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="control-label">Nama Kategori</label>
                                    <input class="form-control form-white" type="text" name="kategori_nama" required />
                                </div>
                            </div>
                    </div>
        ...
        <?php  foreach($kategori->result_array() as $i) :
                  ...
                  ?>
        <!-- Modal edit Data -->
          <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $kategori_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="<?php echo base_url()?>Owner/Barang/updatekategori" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="control-label">Nama Kategori</label>
                                    <input type="hidden" name="kategori_id" value="<?php echo $kategori_id?>">
                                    <input class="form-control form-white" type="text" name="kategori_nama" value="<?php echo $kategori_nama?>" required/>
                                </div>
                            </div>          
                    </div>
                    <div class="modal-footer">
        ...
        <?php foreach($kategori->result_array() as $i) :
                    ...
                    $kategori_nama = $i['kategori_nama'];
                  ?>
        <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $kategori_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url()?>Owner/Barang/hapuskategori" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="kategori_id" value="<?php echo $kategori_id?>"/> 
